...
import { TankerTruckOrderManagementRoutingModule } from './tanker-truck-order-management-routing.module';
import { TankerTruckOrderManagementComponent } from "./tanker-truck-order-management.component";


@NgModule({
  declarations: [TankerTruckOrderManagementComponent],
  imports: [
    CommonModule,
    FormsModule,
    ReactiveFormsModule,
    ...
    MatIconModule,
    NbSecurityModule,
    TankerTruckOrderManagementRoutingModule
  ],
  providers: [
    ExcelService,
    TankerTrucksService,
...
export class TankerTruckOrderManagementModule { }
