...
import { VirtualGasSupplyContractsRoutingModule } from "./virtual-gas-supply-contracts-routing.module";
...
@NgModule({
  declarations: [VirtualGasSupplyContractsComponent, DialogVirtualGasSupplyContractsComponent],
  imports: [
    CommonModule,
    FormsModule,
    ReactiveFormsModule,
    ...
    MatIconModule,
    NbSecurityModule,
    VirtualGasSupplyContractsRoutingModule,
  ],
  providers: [
    ExcelService,
...
export class VirtualGasSupplyContractsModule {}
