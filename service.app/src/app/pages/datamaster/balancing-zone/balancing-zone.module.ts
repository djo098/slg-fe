...
import { BalancingZoneRoutingModule } from "./balancing-zone-routing.module";
...
@NgModule({
  declarations: [BalancingZoneComponent, DialogBalancingZoneComponent],
  imports: [
    CommonModule,
    FormsModule,
    ReactiveFormsModule,
...
export class BalancingZoneModule {}
