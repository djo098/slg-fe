...
import { BalancingRuleRoutingModule } from './balancing-rule-routing.module';
...
@NgModule({
  declarations: [BalancingRuleComponent,DialogRuleComponent,DialogParameterComponent],
  imports: [
    CommonModule,
    FormsModule,
    ReactiveFormsModule,
...
export class BalancingRuleModule { }
