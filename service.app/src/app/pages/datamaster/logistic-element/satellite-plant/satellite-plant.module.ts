...
import { SatellitePlantRoutingModule } from './satellite-plant-routing.module';
...
@NgModule({
  declarations: [DialogSatellitePlantComponent, SatellitePlantComponent],
  imports: [
    CommonModule,
    FormsModule,
    ReactiveFormsModule,
...
export class SatellitePlantModule { }
