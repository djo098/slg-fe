...
import { RegasificationPlantRoutingModule } from './regasification-plant-routing.module';
...
@NgModule({
  declarations: [DialogRegasificationPlantComponent, RegasificationPlantComponent],
  imports: [
    CommonModule,
    FormsModule,
    ReactiveFormsModule,
    ...
    MatIconModule,
    NbSecurityModule,
    RegasificationPlantRoutingModule
  ], providers: [
    ExcelService,
    LogisticElementService,
    { provide: LOCALE_ID, useValue: "en-001" },
    { provide: NbRoleProvider, useClass: RoleProvider },
  ],
})
export class RegasificationPlantModule { }
