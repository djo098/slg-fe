...
import { ConnectionPointRoutingModule } from './connection-point-routing.module';
...
@NgModule({
  declarations: [ConnectionPointComponent, DialogConnectionPointComponent],
  imports: [
    CommonModule,
    FormsModule,
    ReactiveFormsModule,
...
export class ConnectionPointModule { }
