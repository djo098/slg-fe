...
import { RequestSingleClientRoutingModule } from "./request-single-client-routing.module";
...
@NgModule({
  declarations: [RequestSingleClientComponent, DialogRequestSingleClientComponent, DialogRequestSingleClientSchedulingComponent],
  imports: [
    CommonModule,
    FormsModule,
    ReactiveFormsModule,
    ...
    MatIconModule,
    NbSecurityModule,
    RequestSingleClientRoutingModule,
  ],
  providers: [
    ExcelService,
    TankerTrucksService,
...
export class RequestSingleClientModule {}
