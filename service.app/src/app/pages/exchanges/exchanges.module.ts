...
import { ButtonViewComponent, ExchangesComponent } from "./exchanges.component";
import { DialogExchangesComponent } from "./dialog-exchanges/dialog-exchanges.component";
import { DialogScheduleComponent } from "./dialog-schedule/dialog-schedule.component";


@NgModule({
  declarations: [ExchangesComponent,DialogExchangesComponent,DialogScheduleComponent, ButtonViewComponent ],
  imports: [
    CommonModule,
    FormsModule,
    ReactiveFormsModule,
