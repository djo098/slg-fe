...
import { ConsumptionDemandRoutingModule } from './consumption-demand-routing.module';
import { ConsumptionDemandComponent } from "./consumption-demand.component";


@NgModule({
  declarations: [ConsumptionDemandComponent],
  imports: [
    CommonModule,
    FormsModule,
    ReactiveFormsModule,
    ...
    MatIconModule,
    NbSecurityModule,
    ConsumptionDemandRoutingModule
  ], providers: [
    ExcelService,
    DemandService,
...
export class ConsumptionDemandModule { }
