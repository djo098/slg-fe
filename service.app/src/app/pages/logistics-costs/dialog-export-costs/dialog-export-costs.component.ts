...
@Component({
  selector: "slg-dialog-export-costs",
  templateUrl: "./dialog-export-costs.component.html",
  styleUrls: ["./dialog-export-costs.component.scss"],
})
export class DialogExportCostsComponent implements OnInit {
  ...
  constructor(
    ...
    protected ref: NbDialogRef<DialogExportCostsComponent>,
      ...
      .subscribe({
        next: (res) => {
          ...
          this.excelService.exportAsExcelFile(
            objectTemp,
            "logistic_costs_template_" + this.balance_zone
          );
          this.ref.close();
        },
        error: (e) => {
