...
import { LogisticsCostsRoutingModule } from "./logistics-costs-routing.module";
import { DialogExportCostsComponent } from "./dialog-export-costs/dialog-export-costs.component";


@NgModule({
  declarations: [LogisticsCostsComponent, DialogExportCostsComponent],
  imports: [
    CommonModule,
    FormsModule,
    ReactiveFormsModule,
...
export class LogisticsCostsModule {}
